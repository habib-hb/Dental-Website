<div class="flex flex-col w-full m-0 p-0 min-h-[100vh] {{session('theme_mode') == 'light' ? 'bg-[#EFF9FF]' : 'bg-[#090909]'}} ">
    ...
    {{-- All Flash Messages --}}
        ...
        @if (session()->has('patient_details'))
            ...
            <div class="flex flex-col justify-center items-center text-center fixed top-24 left-1/2 translate-x-[-50%] h-fit mx-auto w-[90%] max-w-[400px]  bg-[#1A579F] py-4 rounded-lg z-10">
                <div class="flex flex-row justify-between items-center px-8">
    ...
    {{-- End All Flash Messages --}}
        ...
        <div class="relative">
            ...
            <div class="flex flex-row justify-between items-center mx-auto  md:max-w-[1280px]  md:px-8  py-2 px-4 mt-2 w-full">
                ...
                <h2 class="text-2xl text-center  text-[#1A579F]">Root Canal Treatment Price Estimator</h2>
                ...
                <div class="flex flex-col sticky top-2  justify-between items-center py-2 w-[96vw] md:max-w-[800px]  mx-auto rounded-lg {{session('theme_mode') == 'light' ? 'bg-[#d6e0ec]' : 'bg-[#1e1d1d]'}} shadow-[inset_0_4px_4px_rgba(0,0,0,0.25)] mb-2">
                    <p class="text-center px-4 {{session('theme_mode') == 'light' ? 'text-black' : 'text-white'}}">Please complete the form below to receive an accurate price estimate.</p><hr class="w-[90%] mx-auto {{session('theme_mode') == 'light' ? 'bg-black' : 'bg-white'}} ">
    ...
    {{-- ********* Date Selector ********** --}}
    <h2 class="text-2xl md:text-4xl text-center   text-[#1A579F] w-[90vw] mx-auto  py-2 px-4 rounded-lg mt-8">Appointment</h2>
    ...
    <div class="flex flex-col justify-center items-center mt-2 p-2">
        ...
        <div class="flex flex-row justify-start md:justify-center w-[100%]">
              <p class="text-2xl md:text-center {{session('theme_mode') == 'light' ? 'text-black' : 'text-white'}}">Please Select A Date : {{$select_date_string}}</p>
        </div>
        ...
        <div class="flex flex-col w-full md:max-w-[800px] md:p-8  mt-8">
            ...
            <div class="flex flex-row justify-start md:justify-center w-[100%]">
                <p class="text-xl {{session('theme_mode') == 'light' ? 'text-black' : 'text-white'}}">Patient Details</p>
            </div>
